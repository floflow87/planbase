...
export const BILLING_STATUSES = [
  ...
  { key: "a_facturer", label: "À facturer", order: 45, color: "#FDBA74", colorClass: "bg-orange-100 border-orange-200", textColorClass: "text-orange-700", darkColorClass: "dark:bg-orange-900/30 dark:text-orange-300 dark:border-orange-800" },
  ...
  { key: "partiel", label: "Partiel", order: 60, color: "#5EEAD4", colorClass: "bg-teal-100 border-teal-200", textColorClass: "text-teal-700", darkColorClass: "dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-800" },
  { key: "paye", label: "Payé", order: 70, color: "#86EFAC", colorClass: "bg-green-100 border-green-200", textColorClass: "text-green-700", darkColorClass: "dark:bg-green-900/30 dark:text-green-300 dark:border-green-800", isTerminal: true },
