...
import {
  ...
  Paperclip, ArrowLeft, ArrowRight, Reply, Forward, ExternalLink, Pencil,
} from "lucide-react";
...
const WHITE_TOOLTIP = "bg-white text-gray-900 border border-gray-200 dark:bg-gray-900 dark:text-white dark:border-gray-700";
    ...
    <div className="flex h-full overflow-hidden">
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-2 px-4 py-3 border-b shrink-0">
          ...
          {gmailStatus?.email && (
            <span className="text-xs text-muted-foreground truncate max-w-[120px] hidden sm:block">{gmailStatus.email}</span>
          )}
          {gmailStatus?.canSend && (
            <Tooltip>
              ...
              <TooltipContent className={WHITE_TOOLTIP}>Nouveau message</TooltipContent>
            </Tooltip>
          )}
          <Tooltip>
            <TooltipTrigger asChild>
            ...
            <TooltipContent className={WHITE_TOOLTIP}>Synchroniser</TooltipContent>
          </Tooltip>
        </div>

        {/* White area: search + tabs + list */}
        <div className="flex flex-col flex-1 overflow-hidden bg-white dark:bg-background">
          ...
          <div className="flex items-center gap-2 px-3 border-b shrink-0">
            ...
            {/* Search — half-width */}
            <div className="relative w-[40%] min-w-[100px] max-w-[200px] py-1.5">
                ...
                {messages.map((msg) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-foreground truncate">{decodeHTMLEntities(msg.subject) || "(Sans objet)"}</p>
                      <p className="text-xs text-muted-foreground truncate mt-0.5">{decodeHTMLEntities(msg.snippet)}</p>
      ...
      {selected ? (
        <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-background border-l-2 border-primary">
          {/* Detail header */}
          <div className="flex items-center gap-3 px-4 py-3 border-b shrink-0 bg-white dark:bg-background">
            <Button
              size="icon"
              variant="ghost"
              className="md:hidden"
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-sm truncate">{decodeHTMLEntities(selected.subject) || "(Sans objet)"}</h2>
            </div>
              ...
              {gmailStatus?.canSend && (
                <>
                  <Tooltip>
                    ...
                    <TooltipContent className={WHITE_TOOLTIP}>Répondre</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                    ...
                    <TooltipContent className={WHITE_TOOLTIP}>Transférer</TooltipContent>
                  </Tooltip>
                </>
              )}
              <Tooltip>
                ...
                <TooltipContent className={WHITE_TOOLTIP}>Ouvrir dans Gmail</TooltipContent>
              </Tooltip>
            </div>
          </div>

          {/* Email meta */}
          <div className="px-5 py-4 border-b shrink-0 bg-white dark:bg-background">
          ...
          <div className="flex-1 overflow-hidden bg-white dark:bg-background">
            {selected.bodyHtml ? (
              ...
              <div className="px-5 py-4">
                <p className="text-sm text-muted-foreground italic">{decodeHTMLEntities(selected.snippet)}</p>
              </div>
            ) : (
              <div className="px-5 py-4">
